# Variables copied from upstream module verbatim from:
#   https://github.com/terraform-aws-modules/terraform-aws-vpc/blob/master/variables.tf
#
# Notes:
#   Commented out items which are not relevant for this module
#   Altered some defaults for this module (commented out old defaults)
